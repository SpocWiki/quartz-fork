...
A flag to signal that the [place](schema.org/Type/is_a_/place.md) is open to public visitors.  If this property is omitted there is no assumed default boolean value
