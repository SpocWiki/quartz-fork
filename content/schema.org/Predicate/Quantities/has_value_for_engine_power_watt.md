...
title: has_value_for_engine_power_watt
...
&lt;li&gt;Note 2: You can link to information about how the given value has been determined using the [valueReference](valueReference) property.&lt;/li&gt;
&lt;li&gt;Note 3: You can use [minValue](minValue) and [maxValue](maxValue) to indicate ranges.&lt;/li&gt;
&lt;/ul&gt;
