...
Defines the day(s) of the week on which a recurring [event](schema.org/Type/is_a_/event.md) takes place. May be specified using either [DayOfWeek](DayOfWeek), or alternatively [text](schema.org/Type/is_a_/data_type/text.md) conforming to iCal's syntax for byDay recurrence rules.
