...
A monetary value above (or at) which the shipping rate becomes free. Intended to be used via an [OfferShippingDetails](OfferShippingDetails) with [shippingSettingsLink](shippingSettingsLink) matching this [ShippingRateSettings](ShippingRateSettings).
