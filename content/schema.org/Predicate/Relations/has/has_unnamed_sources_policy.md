...
For an [organization](schema.org/Type/is_a_/organization.md) (typically a [NewsMediaOrganization](NewsMediaOrganization)), a statement about policy on use of unnamed sources and the decision process required.
