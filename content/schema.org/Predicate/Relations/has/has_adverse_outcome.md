...
tag it as a [has_serious_adverse_outcome](schema.org/Predicate/Relations/has/has_serious_adverse_outcome.md) instead.

Relation describes that: 
[ #has_/domain  :: MedicalDevice, TherapeuticProcedure ]
( #has_/name :: has_adverse_outcome )
( #has_/range :: [medical_entity](schema.org/Type/is_a_/medical_entity.md) )
